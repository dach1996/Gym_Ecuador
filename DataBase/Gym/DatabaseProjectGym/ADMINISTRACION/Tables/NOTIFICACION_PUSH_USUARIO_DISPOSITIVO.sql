CREATE TABLE [ADMINISTRACION].[NOTIFICACION_PUSH_USUARIO_DISPOSITIVO] (
    ...
    CONSTRAINT [PK_NOTIFICACION_PUSH_USUARIO_DISPOSITIVO] PRIMARY KEY CLUSTERED ([NPU_ID] ASC, [DIS_ID] ASC),
    CONSTRAINT [FK_NOTIFICACION_PUSH_USUARIO_DISPOSITIVO_DISPOSITIVO] FOREIGN KEY ([DIS_ID]) REFERENCES [AUTENTICACION].[DISPOSITIVO] ([DIS_ID]),
    CONSTRAINT [FK_NOTIFICACION_PUSH_USUARIO_DISPOSITIVO_NOTIFICACION_PUSH_USUARIO] FOREIGN KEY ([NPU_ID]) REFERENCES [ADMINISTRACION].[NOTIFICACION_PUSH_USUARIO] ([NPU_ID])
);
