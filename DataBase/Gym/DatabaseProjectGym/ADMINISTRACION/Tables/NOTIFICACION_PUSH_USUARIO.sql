CREATE TABLE [ADMINISTRACION].[NOTIFICACION_PUSH_USUARIO] (
    ...
    CONSTRAINT [PK_NOTIFICACION_PUSH_USUARIO] PRIMARY KEY CLUSTERED ([NPU_ID] ASC),
    CONSTRAINT [FK_NOTIFICACION_PUSH_USUARIO_NOTIFICACION_PUSH] FOREIGN KEY ([NCP_ID]) REFERENCES [ADMINISTRACION].[NOTIFICACION_PUSH] ([NCP_ID]),
    CONSTRAINT [FK_NOTIFICACION_PUSH_USUARIO_USUARIO] FOREIGN KEY ([USR_ID]) REFERENCES [AUTENTICACION].[USUARIO] ([USR_ID])
);
