CREATE TABLE [AUTENTICACION].[FORMA_REGISTRO_USUARIO] (
    ...
    CONSTRAINT [PK_FORMA_REGISTRO_USUARIO] PRIMARY KEY CLUSTERED ([USR_ID] ASC, [FRU_CODIGO_TIPO_REGISTRO] ASC),
    CONSTRAINT [FK_FORMA_REGISTRO_USUARIO] FOREIGN KEY ([USR_ID]) REFERENCES [AUTENTICACION].[USUARIO] ([USR_ID])
);
