CREATE TABLE [AUTENTICACION].[USUARIO] (
    ...
    CONSTRAINT [FK_USUARIO_ARCHIVOS_GUARDADOS_IMAGEN_USUARIO] FOREIGN KEY ([ARG_ID_IMAGEN_USUARIO]) REFERENCES [ADMINISTRACION].[ARCHIVOS_GUARDADOS] ([ARG_ID]),
    CONSTRAINT [UQ_CORREO] UNIQUE NONCLUSTERED ([USR_CORREO] ASC),
    CONSTRAINT [UQ_USERNAME] UNIQUE NONCLUSTERED ([USR_USERNAME] ASC)
);
