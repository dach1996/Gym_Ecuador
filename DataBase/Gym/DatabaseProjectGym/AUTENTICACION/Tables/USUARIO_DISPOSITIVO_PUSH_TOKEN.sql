CREATE TABLE [AUTENTICACION].[USUARIO_DISPOSITIVO_PUSH_TOKEN] (
    ...
    CONSTRAINT [PK_USUARIO_DISPOSITIVO_PUSH_TOKEN] PRIMARY KEY CLUSTERED ([DIS_ID] ASC),
    CONSTRAINT [FK_USUARIO_DISPOSITIVO_PUSH_TOKEN_DISPOSITIVO_1] FOREIGN KEY ([DIS_ID]) REFERENCES [AUTENTICACION].[DISPOSITIVO] ([DIS_ID]),
    CONSTRAINT [FK_USUARIO_DISPOSITIVO_PUSH_TOKEN_USUARIO] FOREIGN KEY ([USR_ID]) REFERENCES [AUTENTICACION].[USUARIO] ([USR_ID])
);
