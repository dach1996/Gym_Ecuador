CREATE TABLE [AUTENTICACION].[USUARIO_DISPOSITIVO] (
    ...
    CONSTRAINT [PK_USUARIO_DISPOSITIVO] PRIMARY KEY CLUSTERED ([USR_ID] ASC, [DIS_ID] ASC),
    CONSTRAINT [FK_USUARIO_DISPOSITIVO_DISPOSITIVO] FOREIGN KEY ([DIS_ID]) REFERENCES [AUTENTICACION].[DISPOSITIVO] ([DIS_ID]),
    CONSTRAINT [FK_USUARIO_DISPOSITIVO_USUARIO] FOREIGN KEY ([USR_ID]) REFERENCES [AUTENTICACION].[USUARIO] ([USR_ID])
);
