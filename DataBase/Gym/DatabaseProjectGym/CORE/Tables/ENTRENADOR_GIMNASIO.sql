CREATE TABLE [CORE].[ENTRENADOR_GIMNASIO] (
    ...
    [EGY_ESTADO]         BIT      CONSTRAINT [DEFAULT_ENTRENADOR_GIMNASIO_EGY_ESTADO] DEFAULT ((1)) NOT NULL,
    CONSTRAINT [PK_ENTRENADOR_GIMNASIO] PRIMARY KEY CLUSTERED ([EGY_ID] ASC),
    CONSTRAINT [FK_ENTRENADOR_GIMNASIO_ENTRENADOR] FOREIGN KEY ([ENT_ID]) REFERENCES [CORE].[ENTRENADORES] ([ENT_ID])
);
