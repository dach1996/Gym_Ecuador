...
public class PanamericanaGetSeatAvailableHandler(
    ILogger<PanamericanaGetSeatAvailableHandler> logger,
    IPluginFactory pluginFactory) : GetSeatAvailableHandler(logger, pluginFactory), IGetSeatAvailableHandler
{
