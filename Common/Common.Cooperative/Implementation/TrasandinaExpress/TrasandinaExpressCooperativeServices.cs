...
namespace Common.Cooperative.Implementation.Trasandina;
/// <summary>
/// Implementaciòn para Trasandina Express
/// </summary>
/// <remarks>
/// Constructor
/// </remarks>
...
/// <returns></returns>
public class TrasandinaExpressCooperativeServices(
    ILogger<TrasandinaExpressCooperativeServices> logger) : CooperativeServicesBase(logger), ICooperativeServices
{
    /// <summary>
    /// Implementación
    /// </summary>
    /// <returns></returns>
    protected override CooperativeImplementationName ImplementationName => CooperativeImplementationName.TrasandinaExpress;
    ...
    public async Task<GetAvailableTripsResponse> GetAvailableTripsAsync(GetAvailableTripsRequest request)
    {
        ...
        return await Task.FromResult(new GetAvailableTripsResponse(ImplementationName, new List<Ticket>{
            new(){
            Identifier = "TrasandinaExpress-RUTA_1",
              OriginStationCode="Quito-Ofelia",
        DestinationStationCode ="Ibarra",
        ApproximatePrice=10,
        BusCode="BUS_TRANS_EXPRESS_4",
        Schedule = new (){
        ...
        BusType = Models.Enums.BusType.BusSingleFloor,
            ...
            new(){
            Identifier = "TrasandinaExpress-RUTA_2",
       ...
       SeatAvailable = 10
            ...
            new(){
            Identifier = "TrasandinaExpress-RUTA_3",
        ...
        SeatAvailable = 10
         ...
         new(){
            Identifier = "TrasandinaExpress-RUTA_4",
    ...
    public async Task<GetBusSeatResponse> GetBusSeatAsync(GetBusSeatRequest request)
    {
        ...
        var tuple = new List<Tuple<string, string>>(){
            Tuple.Create("TrasandinaExpress-1","BUS_TRANS_EXPRESS_4"),
            Tuple.Create("TrasandinaExpress-2","BUS_TRANS_EXPRESS_5"),
            Tuple.Create("TrasandinaExpress-3","BUS_TRANS_EXPRESS_6"),
        };
