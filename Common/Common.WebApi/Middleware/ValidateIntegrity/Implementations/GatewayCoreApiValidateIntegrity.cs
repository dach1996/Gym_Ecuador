...
public class GatewayCoreApiValidateIntegrity(ILogger<GatewayCoreApiValidateIntegrity> logger, IPluginFactory pluginFactory, AppSettingsApi appSettings)
    : ValidateIntegrityBase(logger, pluginFactory, appSettings)
{
    ...
    {
        var contextRequest = httpContext.Items[nameof(CommonContextRequest)] as ContextRequest;
