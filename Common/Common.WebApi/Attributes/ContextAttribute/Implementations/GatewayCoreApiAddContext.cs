...
public class GatewayCoreApiAddContext(
    AppSettingsApi appSettings,
    ILogger<GatewayCoreApiAddContext> logger) : AddContextBase(logger, appSettings)
{
    public override void OnActionExecuting(ActionExecutingContext context)
    {
        foreach (var parameterDescriptor in context.ActionDescriptor.Parameters)
        {
            ...
            postObject.ContextRequest = context.HttpContext.Items[nameof(CommonContextRequest)] as ContextRequest;
            Task.Run(() =>
            {
