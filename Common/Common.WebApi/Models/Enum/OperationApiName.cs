...
public enum OperationApiName
{
    ...
    /// <summary>
    /// Obtener Sucursales de Gimnasio
    /// </summary>
    ...
    /// <summary>
    /// Obtener Estadísticas de Seguimientos de Procesos
    /// </summary>
    [EnumMember(Value = "Obtener Estadísticas de Seguimientos de Procesos")]
    GetProcessTrackingStatistics,
