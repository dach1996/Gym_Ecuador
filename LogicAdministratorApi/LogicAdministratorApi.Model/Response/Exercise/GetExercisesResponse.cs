...
public class GetExercisesResponse(int totalRegister, IEnumerable<ExerciseItem> registers) : IPaginatorApiResponse<ExerciseItem>
{
    /// <summary>
    /// Mensaje al Usuario
    /// </summary>
    ...
    /// Registros
    /// </summary>
    public IEnumerable<ExerciseItem> Registers { get; set; } = registers;
}
