...
namespace LogicAdministratorApi.BusinessLogic.PersonHandler;
...
public class GetPersonByDocumentNumberHandler(
    ...
    IPluginFactory pluginFactory) : PersonBase<GetPersonByDocumentNumberRequest, GetPersonByDocumentNumberResponse>(
        logger,
        pluginFactory)
{
    /// <summary>
